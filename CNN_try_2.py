...
'''
m = CNN()
m.add(Conv2d(input_shape = (28, 28, 1), filters = 6, padding=None, kernel_size=(5, 5), activation="relu"))
m.add(Pool2d(kernel_size=(2, 2)), 2)
...
m.compile_model(lr=0.01, opt="sgd", loss="cse")
m.summary()
